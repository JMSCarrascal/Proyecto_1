...
<body>
    <div class="container-fluid">
            ...
            <form action="{{route('sales.index')}}" method="get">
                <div class="row bg-gradient pt-4 bg-gradient rounded thead_page">
                    ...
                    <div class="col-12 col-md-4 col-lg-4 mb-3 d-flex justify-content-end">
                        <button type="button" class="btn btn-success bg-gradient" data-bs-toggle="modal" data-bs-target="#modal_created">
        ...
        {{-- created modal --}}
        <div class="modal fade" id="modal_created" tabindex="-1" aria-labelledby="modal_createdLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="modal_createdLabel">Add New Sale</h5>
                                ...
                                <tr>
                                    ...
                                    <td class="sticky-left">
                                        <div>
                                            ...
                                            <button type="button" class="btn btn-warning btn-sm mb-1 pt-2 option_buttons" data-bs-toggle="modal" 
                                            data-bs-target="#modal_update_sale_{{$sale->id}}"><span
                                    ...
                                    <td>
                                        {{-- EDIT MODAL --}}
                                        <div class="modal fade" id="modal_update_sale_{{$sale->id}}" tabindex="-1" aria-labelledby="modal_update_sale_Label" 
                                        aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                              <div class="modal-content">
                                                <div class="modal-header">
                                                  <h5 class="modal-title" id="modal_update_sale_Label">Modal title</h5>
                                                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <form action="{{route('sales.update',$sale->id)}}" method="post">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                            <button type="submit" class="btn btn-primary"><span class="material-icons-outlined align-middle text-white" style="font-size: 20px">
                                                                save
